<div class="flex h-screen bg-gray-100">
    ...
    <div class="flex flex-1 items-center justify-center">
        <form action="./?action=ajoutPort" method="POST" class="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
            <h3 class="text-2xl font-bold text-center text-blue-600 mb-6">Ajouter un port</h3>
            
            <!-- Champ Nom -->
            <div class="mb-6">
                <label for="nom" class="block text-sm font-medium text-gray-700 mb-1">Nom du Port</label>

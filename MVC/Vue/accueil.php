                ...
                <form action='' method='post' class='space-y-6'>
                    <div name='traversee'>
                        ...
                        foreach ($traversees as $traversee) {
                            $heureDepart = new DateTime($traversee['dateDepart']);
                            $heureArrivee = new DateTime($traversee['dateArrive']);
                                    ...
                                    <div class='flex justify-between'>
                                        <div class='flex flex-col'>
                                            <div class='text-lg font-NeueMontrealRegular'>
                                                <?php echo date('H:i', strtotime($traversee['dateDepart']));?>
                                            </div>
                                            <div class='text-lg font-NeueMontrealRegular'>
                                                <?php echo date('H:i', strtotime($traversee['dateArrive'])); ?>
                                            </div>
                                        </div>
